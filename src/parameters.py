...
EMAIL_RECEIVER = 'caiews20002@glbitm.ac.in'
...
VIDEO_PATH =  'src/static/files/vid1.mp4'                     

# The path where the video will be uploaded
VIDEO_UPLOAD_PATH ='src/static/video/vid.mp4'

# The path where logs will be stored
LOG_FILE_PATH = 'logs/multicam_server.log'# face matching tolerance (distance -> less the distance, more the similarity)
...
# buffer size for video streaming to minimize incosistent network conditions
...
# IP Camera Details
IP_CAMS = {'cam1': 'http://152.20.16.109:4747/video',
           #'cam2': 'http://152.20.16.109:4747/video',
          }
